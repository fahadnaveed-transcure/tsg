...
class image_gallery extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'centered',
			array(
				'label'     => __( 'Slider Centered', 'finix' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'false',
				'condition' => array( 'client-style' => array( 'slider' ) ),
				'options'   => array(
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gallery-item-main .gallery-item-inner.grid-column-1' => 'grid-gap: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .gallery-item-main .gallery-item-inner.grid-column-2' => 'grid-gap: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .gallery-item-main .gallery-item-inner.grid-column-3' => 'grid-gap: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .gallery-item-main .gallery-item-inner.grid-column-4' => 'grid-gap: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .gallery-item-main .gallery-item-inner.grid-column-5' => 'grid-gap: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .gallery-item-main .gallery-item-inner.grid-column-6' => 'grid-gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .gallery-item-main.style-border .gallery-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .gallery-item-main .swiper-container .swiper-pagination-bullet' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .gallery-item-main .swiper-container .swiper-pagination-bullet.swiper-pagination-bullet-active' => 'background: {{VALUE}};',
					'{{WRAPPER}} .gallery-item-main .swiper-container .swiper-pagination-bullet.swiper-pagination-bullet-active:before' => 'border-color: {{VALUE}};',
				],
			]
		);
	...
	/**
	 * Render Image Gallery output on the frontend.
	 *
	...
	protected function render() {
		...
		?>
		<div class="gallery-item-main <?php echo $arrow_style; ?>">
		<?php
		if ( $settings['client-style'] === 'slider' ) {
			...
			$this->add_render_attribute( 'client', 'data-centered', $settings['centered'] );
			?>
			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<div class="gallery-item">
						<a class="popup-img" href="<?php echo esc_url( $item['image']['url'] ); ?>">
		...
		if ( $settings['client-style'] === 'grid' ) {
			...
			?>
			<div class="gallery-item-inner <?php echo $grid_opt; ?> <?php echo $mo_grid_opt; ?>">
				<?php
				foreach ( $tabs as $index => $item ) {
		...
		<script>
			jQuery('.swiper-container' ).each(function () {
				...
				centeredSlides: ((jQuery(this).attr('data-centered')) ? jQuery(this).data('centered') : false),
				navigation: {
...
Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\image_gallery() );
?>
