 ...
 */
function finix_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Finix default saturation level.
	 *
	 * @since finix 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'finix_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.finix-front-page) .entry-title,
...
.colors-custom .finix-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.finix-front-page .panel-content .recent-posts article,
...
.colors-custom.finix-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Finix custom colors CSS.
	 *
	 * @since finix 1.0
	 *
	 ...
	 */
	return apply_filters( 'finix_custom_colors_css', $css, $hue, $saturation );
}
